...
# -*- coding: utf-8 -*-
#
# ssbio documentation build configuration file, created by
# sphinx-quickstart on Wed Nov 15 13:03:28 2017.
#
...
# Allow errors in nbsphinx and do not execute
...
latex_documents = [
    (master_doc, 'ssbio.tex', 'ssbio Documentation',
     'Nathan Mih', 'manual'),
]
...
man_pages = [
    (master_doc, 'ssbio', 'ssbio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ssbio', 'ssbio Documentation',
     author, 'ssbio', 'One line description of project.',
     'Miscellaneous'),
]
